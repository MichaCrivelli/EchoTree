...
AEchoTreeCharacter::AEchoTreeCharacter()
{
...
void AEchoTreeCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	{
		UE_LOG(LogEchoTree, Error, TEXT("'%s' Failed to find an Enhanced Input component! This template is built to use the Enhanced Input system. If you intend to use the legacy system, then you will need to update this C++ file."), *GetNameSafe(this));
	}
}

void AEchoTreeCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AEchoTreeCharacter::DoJumpEnd()
{
